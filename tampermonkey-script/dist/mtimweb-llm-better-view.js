...
(function () {
  ...
  function aggregateChoices(events) {
    ...
    for (const event of events) {
      console.log((_b = (_a = event == null ? void 0 : event.choices) == null ? void 0 : _a[0]) == null ? void 0 : _b.delta);
        ...
        if (delta) {
          ...
          if (delta.tool_calls) {
            for (const toolCallDelta of delta.tool_calls) {
              ...
              if ((_c = toolCallDelta.function) == null ? void 0 : _c.name) toolCall.function.name = toolCallDelta.function.name;
              if ((_d = toolCallDelta.function) == null ? void 0 : _d.arguments) {
  ...
  const openai_req_template = `<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="UTF-8" />
...
`;
  const openai_res_template = `<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
...
`;
  const openai_res_sse_template = (events) => `<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  ...
  async function handleFlowRequest(resp, rawRequest) {
  ...
  async function handleFlowResponse(resp, rawRequest) {
  ...
  async function reFetchFullLineOfFlow(rawRequest) {
  ...
  async function createIFrameElement(html) {
    ...
    iframe.onload = function() {
      var _a, _b;
      try {
        const iframeDocument = iframe.contentDocument || ((_a = iframe.contentWindow) == null ? void 0 : _a.document);
        const height = iframeDocument == null ? void 0 : iframeDocument.documentElement.scrollHeight;
        iframe.style.height = height + "px";
      } catch (e) {
        console.warn(e);
      }
      (_b = iframe.contentWindow) == null ? void 0 : _b.document.addEventListener("click", (e) => {
        setTimeout(() => {
          var _a2;
          try {
            const iframeDocument = iframe.contentDocument || ((_a2 = iframe.contentWindow) == null ? void 0 : _a2.document);
